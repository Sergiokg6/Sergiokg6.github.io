  ...
  [1664],
  {
    ...
    5569: function (e, t, n) {
      ...
      let O = o.default.forwardRef(function (e, t) {
          ...
          o.default.useEffect(() => {
            x && q && I && v(x, w, K, { locale: T }, { kind: L }, U);
          ...
          if ((0, a.isAbsoluteUrl)(K)) G.href = K;
            ...
            G.href =
              t ||
              (0, y.addBasePath)(
                (0, i.addLocale)(K, e, null == N ? void 0 : N.defaultLocale)
              );
          }
          return A
            ? o.default.cloneElement(r, G)
            : o.default.createElement("a", { ...k, ...G }, n);
        }),
        g = O;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
